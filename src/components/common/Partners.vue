    ...
    <v-container fluid >
        <v-row align="center" justify="center" class="mb-0">
            <v-col cols="12" md="12" lg="12" sm="12" class="mb-0">
                ...
                <p class="google-font mt-1 mb-0" style="font-size:100%">Muchas gracias a todos nuestros patrocinadores por su asociación continua.</p>
                <p class="google-font mt-0 mb-0" style="font-size:100%">Si estás interesado en ser exhibido, pónte en contacto con <a style="color:#1565C0;text-decoration: none;" :href="`mailto:${config.generalConfig.email}`">{{config.generalConfig.email}}</a> para discutir oportunidades de patrocinio.</p>
            </v-col>
        </v-row>
        ...
        <v-row align="center" v-if="checkExistance(partnersData,0)" justify="start" class="mt-0 pt-0">
            <v-col cols="12" md="12" lg="12" sm="12" class="mx-0 mt-0">
                <p class="google-font mb-0" style="font-size:130%">Partners</p>
            </v-col>
